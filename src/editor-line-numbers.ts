...
/**
 * Whole-line selection for the line-number gutter. The selected range is an
 * ordinary CodeMirror text selection, so normal clipboard and edit commands
 * apply without a second selection model.
 */
