...
export interface LintPreference { revision: number; enabled: boolean; realtime: boolean; rules?: RuleOverrides }
export const lintPreference = (enabled?: boolean, rules?: RuleOverrides, resetRules = false, realtime?: boolean) =>
  editorCommand<LintPreference>({ kind: "lintPreference", enabled, realtime, rules, reset_rules: resetRules });
